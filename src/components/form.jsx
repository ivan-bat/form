...
const Form = () => {
    ...
    const validateSchema = {
        ...
        password: {
            isPassword: {
                massage: "Пароль должен содержать хотя бы одну латинскую букву в верхнем регистре"
            },
            isPasswordNumber: {
    ...
    return (
        ...
        <form onSubmit={onSubmit} >
            ...
            />
            <button className={isValid ? "btn" : ""} ref={submitButtonRef} type="submit" disabled={!isValid}>{"Зарегистрироваться"}</button>
        </form>
        </div>
    );
};
